...
process.env.REQUIRE_MODERATION = 'true';
process.env.CONTENT_THROTTLE_TTL_MS = '60000';
process.env.CONTENT_THROTTLE_LIMIT = '1000';
process.env.TRAVEL_INGESTION_THROTTLE_TTL_MS = '60000';
process.env.TRAVEL_INGESTION_THROTTLE_LIMIT = '1000';
